...
class PDF extends FPDF
{
    ...
    public function Header()
    {
        ...
        $this->Text(5, 36, 'Apellido, nombre');
        $this->Text(65, 36, utf8_decode('Área'));
        $this->Text(120, 36, 'Producto (Marca)');
        $this->Text(185, 36, 'Total');
    ...
    public function Footer()
    {
        ...
        $this->Text(155, 281.5, utf8_decode("Cómputos Web - Total pedidos por usuario"));
    }
}
