...
class PDF extends FPDF
{
    ...
    public function Header()
    {
        ...
        $this->Text(15, 36, utf8_decode('Área'));
        $this->Text(90, 36, utf8_decode('Producto (Marca)'));
        $this->Text(180, 36, 'Total');
    ...
    public function Footer()
    {
        ...
        $this->Text(160, 281.5, utf8_decode("Cómputos Web - Total pedidos por área"));
    }
}
